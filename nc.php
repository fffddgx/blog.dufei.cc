...
<div class="page">
	...
	<section class="demo">
<div class="demo_con">
	<button type="button" class="button red" onclick="javascript:location='http://blog.dufei.cc/nc.php?id=0&s=0'">pc熬夜模式</button>
	<button type="button" class="button green" onclick="javascript:location='http://blog.dufei.cc/nc.php?id=0&s=1'">pc早睡模式</button>
</div>	
<div class="demo_con">
	<button type="button" class="button red" onclick="javascript:location='http://blog.dufei.cc/nc.php?id=1&s=0'">pad熬夜模式</button>
	<button type="button" class="button green" onclick="javascript:location='http://blog.dufei.cc/nc.php?id=1&s=1'">pad早睡模式</button>
</div>	
<div class="demo_con">
	<button type="button" class="button red" onclick="javascript:location='http://blog.dufei.cc/nc.php?id=2&s=0'">phone熬夜模式</button>
	<button type="button" class="button green" onclick="javascript:location='http://blog.dufei.cc/nc.php?id=2&s=1'">phone早睡模式</button>
</div>	
	</section>
</div>
...
if((empty($id)&& $id !== "0") || ($status !== "0" && empty($status))){
	exit;;
}
$res = `curl "http://1.94.33.231/userRpm/AccessCtrlAccessRulesRpm.htm?enable=".$status."&enableId=".$id."&Page=1" -b "Authorization=Basic%20YWRtaW46ZHVmZWlANDMyMQ%3D%3D; ChgPwdSubTag=" -e "http://1.94.33.231/userRpm/AccessCtrlAccessRulesRpm.htm?enableCtrl=1&defRule=1&Page=1"`;

$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://1.94.33.231/userRpm/AccessCtrlAccessRulesRpm.htm?enable=".$status."&enableId=".$id."&Page=1");
curl_setopt($ch, CURLOPT_COOKIE, "Authorization=Basic%20YWRtaW46ZHVmZWlANDMyMQ%3D%3D; ChgPwdSubTag=");
curl_setopt($ch, CURLOPT_REFERER, "http://1.94.33.231/userRpm/AccessCtrlAccessRulesRpm.htm?enableCtrl=1&defRule=1&Page=1");
